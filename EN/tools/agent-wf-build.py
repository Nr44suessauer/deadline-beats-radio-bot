...
Generated by tools/agent-wf-build.py - never change by hand.
Change: agent-patch.sh --content ... then agent-deploy-only.sh.
Docs: README.md sections 8 to 12 and tools/README.md."""
...
dokunotiz(konfiguration, W_KONFIG_NAME, [
    ...
    "Change: tools/agent-wf-build.py (KONFIG) -> agent-deploy-only.sh",
])
...
dokunotiz(agent, "Radio - Telegram-Agent", [
    ...
    "The plan is the source of the layout: tools/agent-wf-build.py (ANORDNUNG, AREAS, KURZNOTIZ).",
    "Change: agent-patch.sh --cleanup -> agent-deploy-only.sh /tmp/radio-agent-new.json -> docker restart n8n",
    "Check: anordnung-check.py (0 findings), code-check.py (0 faulty code nodes), OPERATIONS.md",
    "Description: README.md, MANUAL.md, MANUAL.md, OPERATIONS.md, OPERATIONS.md, OPERATIONS.md, BUILD.md",
    "Image by image: APPENDIX/n8n-interface.html",
])
# ------------------------------------------------- layout of the tools
...
dokunotiz(werkzeuge[0], "tool - Radio", [
    ...
    "The plan is the source: tools/agent-wf-build.py (W_ANORDNUNG, W_BEREICHE).",
    "Change/check like the agent; description: MANUAL.md, MANUAL.md, APPENDIX/n8n-interface.html",
])
dokunotiz(werkzeuge[1], "tool - AzuraCast", [
    ...
    "The plan is the source: tools/agent-wf-build.py (W_ANORDNUNG_AZ, W_AZ_BEREICHE).",
    "Change/check like the agent; description: MANUAL.md, APPENDIX/n8n-interface.html",
])
dokunotiz(werkzeuge[2], "Tool - Messages", [
    ...
    "The plan is the source: tools/agent-wf-build.py (W_MELD_ANORDNUNG, W_MELD_BEREICHE).",
    "Change/check like the agent; description: MANUAL.md §1.3, MANUAL.md",
])
