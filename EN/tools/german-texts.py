...
a file or command name will remain untouched (protection list below) — "n8n-interface.html",
"--cleanup", "anordnung-check.py" and "MANUAL.md" therefore remain as
they are.
...
SCHUTZ = [
    "n8n-interface", "FAEHIGKEITEN", "STOERUNGEN", "anordnung-check",
