...
Call:
  python3 werkzeuge/code-uebersetzen-en.py --all            # all files
  python3 werkzeuge/code-uebersetzen-en.py <file> [file …]
  python3 werkzeuge/code-uebersetzen-en.py --all --check  # check only
"""
